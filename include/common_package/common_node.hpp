...
protected:
   ...
   *
   * This function sets the `node_active` flag to true, indicating that the node
   * is active.
   */
  void activate() {
    node_active = true;
   ...
   * "error_msg" key to your error message string if you want to have it appear
   * on the mission control output log.
   */
